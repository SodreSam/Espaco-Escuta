...
verResultadoBtn.addEventListener("click", () => {
  ...
  if (simCount === 0) {
    ...
    botoes = `<button onclick="window.location.href='autocuidado.html'">Explorar autocuidado</button>`;
    ...
    botoes = `
      ...
      <button onclick="window.location.href='autocuidado.html'">Explorar autocuidado</button>
    `;
  }
